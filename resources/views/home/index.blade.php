...
@section('content')
    ...
    <div class="banner">
        ...
        <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
            <ul class="am-slides">
                <li class="banner1"><a href="introduction.html"><img src="/assets/shop/images/ad1.jpg" /></a></li>
                <li class="banner2"><a><img src="/assets/shop/images/ad2.jpg" /></a></li>
                <li class="banner3"><a><img src="/assets/shop/images/ad3.jpg" /></a></li>
                <li class="banner4"><a><img src="/assets/shop/images/ad4.jpg" /></a></li>
    ...
    <div class="shopNav">
        <div class="slideall">
                            ...
                            <ul class="category-list" id="js_climit_li">
                                <li class="appliance js_toggle relative first">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
                                        <em>&gt;</em></div>
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
                                ...
                                <li class="appliance js_toggle relative last">
                                    <div class="category-info">
                                        <h3 class="category-name b-category-name"><i><img src="/assets/shop/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
                                        <em>&gt;</em></div>
                                    <div class="menu-item menu-in top">
                                        <div class="area-in">
                                            <div class="area-bg">
            ...
            <div class="am-g am-g-fixed smallnav">
                ...
                <div class="am-u-sm-3">
                    <a href="#"><img src="/assets/shop/images/mansmall.jpg" />
                    ...
                    <ul>
                        ...
                        <div class="mod-vip">
                            <div class="m-baseinfo">
                                <a href="/assets/shop/person/index.html">
                            ...
                            <div class="member-logout">
                                <a class="am-btn-warning btn" href="{{ route('login') }}">登录</a>
                                <a class="am-btn-warning btn" href="{{ route('register') }}">注册</a>
                            </div>
                            @else
        ...
        <div class="shopMain" id="shopmain">
            ...
            <div class="am-u-sm-4 am-u-lg-3 ">
                ...
                <div class="recommendationMain one">
                    <a href="introduction.html"><img src="/assets/shop/images/tj.png "></img></a>
                </div>
            </div>
            <div class="am-u-sm-4 am-u-lg-3 ">
                <div class="info ">
                ...
                <div class="recommendationMain two">
                    <img src="/assets/shop/images/tj1.png "></img>
                </div>
            </div>
            <div class="am-u-sm-4 am-u-lg-3 ">
                <div class="info ">
                ...
                <div class="recommendationMain three">
                    <img src="/assets/shop/images/tj2.png "></img>
                </div>
            </div>
    ...
    <div class="navCir">
        ...
        <li><a href="/assets/shop/person/index.html"><i class="am-icon-user"></i>我的</a></li>
    </div>
